      ...
      <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-16 px-6 py-16">
        <section className="flex flex-col items-center gap-6 text-center">
          ...
          <p className="max-w-xl text-balance text-zinc-500 dark:text-zinc-400">
            Runners League is a community for runners pursuing the World Marathon Majors. Log your finishes, follow the
        ...
        <section className="flex flex-col gap-6">
          <div className="text-center">
            <h2 className="text-lg font-semibold">World Marathon Majors</h2>
            <p className="mt-1 text-sm text-zinc-500">
              The races currently recognized as World Marathon Majors, as of {currentYear}.
            </p>
          </div>
