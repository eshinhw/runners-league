            ...
            <form ref={formRef} onSubmit={handleSubmit} className="flex flex-col gap-3">
              ...
              <div>
                ...
                <div className="flex flex-col gap-2">
                  <input name="bibNumber" placeholder="Bib number" className={inputCls} />
                  <div className="grid grid-cols-2 gap-2">
                    <input name="officialFirstName" placeholder="Official first name" className={inputCls} />
                    <input name="officialLastName" placeholder="Official last name" className={inputCls} />
                  </div>
                </div>
              </div>
